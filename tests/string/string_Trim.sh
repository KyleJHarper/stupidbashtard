...
echo
string_Trim -d 'right' -c '-' 'some_string-------'
  [ "$(string_Trim -d 'right' -c '-' 'some_string-------')" == 'some_string' ]  || fail 1
  [ "$(string_Trim -d 'left'  -c '-' '-------some_string')" == 'some_string' ]  || fail 2
  [ "$(string_Trim -d 'both'  -c '-' '----some_string-')" == 'some_string' ]    || fail 3
  pass
exit
